...
7. Share a GitHub repository to Github account “Docme Cloud” and send an email to HR team (hr@docme.cloud) about the completion along with Github repository link and branch details.
